    ...
    try{
        ...
        const msg = `
            <div style="font-family: Arial, sans-serif; color: #333;">
                ...
                <p>If you have any questions or need assistance, feel free to reach out to our support team at your.kavach@gmail.com🛡️.</p>
                <p>Best regards,</p>
                <p>The KAVACH Team</p>
            </div>
            `
...
const mailVerification = async(req,res)=>{
    try {
        ...
        const isUserID = userModel.findOne({_id:req.query.id});
        if(isUserID)
        {
            if(isUserID.is_verified == true){
            ...
            return res.render('mail-verification', {message:'Mail has been verified Sucessfully!'});
        }
        else
        {
