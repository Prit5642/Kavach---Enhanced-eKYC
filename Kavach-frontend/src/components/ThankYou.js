    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-cover bg-center" style={{ backgroundImage: "url('https://source.unsplash.com/random/1920x1080')" }}>
            <div className="bg-white bg-opacity-80 p-8 rounded-lg shadow-lg text-center">
                ...
                <p className="text-2xl text-gray-700 mb-4">Your registration was successful. Please check the confirmation email to verify your Email ID.</p>
                <Link to="/login" className="inline-block text-xl text-blue-600 border border-blue-600 px-6 py-2 rounded-full hover:bg-blue-600 hover:text-white transition duration-300">
                    Go to Login
                </Link>
            </div>
            <div className="mt-8">
