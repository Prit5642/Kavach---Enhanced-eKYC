...
function ProjectPlannerForm() {
    ...
    const handleAadharVerify = async (e) => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/uploadAadhaar', {
                method: 'POST',
                headers: {
    ...
    const handlePANVerify = async (e) => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/uploadPAN', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
    ...
    const handleFormData = async(e) => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/v1/form/kycform/', {
                method: 'POST',
                headers: {
